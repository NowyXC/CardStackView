...
public class RecyclerActivity extends AppCompatActivity implements CardStackView.ItemExpendListener {

    private CardStackView mStackView;
    private LinearLayout mActionButtonContainer;
    private RecyclerStackAdapter mTestStackAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTestStackAdapter = new RecyclerStackAdapter(this);
        ...
        new Handler().postDelayed(
                new Runnable() {
                    @Override
                    public void run() {
                        mTestStackAdapter.updateData(getData(6));
                    }
                }
                , 200
        );
